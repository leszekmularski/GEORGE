...
namespace GEORGE.Client.Pages.Schody
{
    ...
    public class CSchody : Shape
    {
        ...
        public CSchody(IJSRuntime jsRuntime, double x, double y, double skala, double dlugoscOtworu, double szerokoscOtworu, double dlugoscNaWejsciu, double wysokoscDoStropu, double wysokoscCalkowita, double liczbaPodniesienStopni, 
