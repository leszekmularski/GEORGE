                ...
                this.drilldown = function(dataCell, pivotId) {
                    if (dataCell) {
                        ...
                        if (dataCell.rowType === uiheaders.HeaderType.GRAND_TOTAL && dataCell.colType === uiheaders.HeaderType.GRAND_TOTAL) {
                            title = 'Suma Całkowita';
                        } else {
                            if (dataCell.rowType === uiheaders.HeaderType.GRAND_TOTAL) {
                                title = dataCell.columnDimension.value + '/Suma Całkowita ';
                            } else if (dataCell.colType === uiheaders.HeaderType.GRAND_TOTAL) {
                                title = dataCell.rowDimension.value + '/Suma Całkowita ';
                            } else {
        ...
        18: [function(_dereq_, module, exports) {
                    ...
                    switch (cell.template) {
                        ...
                        case 'cell-template-column-header':
                            ...
                            if (isWrapper || isSubtotal) {
                                ...
                                value = (cell.value || '&#160;') + (cell.type === uiheaders.HeaderType.SUB_TOTAL ? ' Razem' : '');
                            }
                            break;
                ...
                render: function() {
                    ...
                    if (config.canMoveFields) {
                        ...
                        fieldsDropTarget = React.createElement("tr", null,
                            React.createElement("td", {
                                ...
                                React.createElement("div", null, "Pola")
                            ),
                            React.createElement("td", {
                                    className: "av-flds"
                                },
                    ...
                    var dataDropTarget = React.createElement("tr", null,
                        React.createElement("td", {
                            ...
                            React.createElement("div", null, "Dane")
                        ),
                        React.createElement("td", {
                                className: "empty"
                            },
            ...
            module.exports.FilterPanel = react.createClass({
                ...
                render: function() {
                    ...
                    addCheckboxRow(filtering.ALL, '(Pokaż wszystko)');
                    if (this.values.containsBlank) {
                        addCheckboxRow(filtering.BLANK, '(Puste)');
                    }
                        ...
                        React.createElement("tbody", null,
                            React.createElement("tr", null,
                                ...
                                React.createElement("td", {
                                    ...
                                    title: "Włączanie/wyłączanie wyrażeń regularnych"
                                }, ".*"),
                                React.createElement("td", {
            ...
            defaultToolbarConfig.buttons = [{
                ...
                type: 'button',
                tooltip: 'Eksport do programu Excel',
                cssClass: 'export-xls',
