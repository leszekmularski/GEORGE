...
{
    /// <inheritdoc />
    public partial class InitialMigration76 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RodzajWypelnienia = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    Grubosc = table.Column<double>(type: "float", nullable: false),
                    WysokoscProgu = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Drzwi", x => x.Id);
                });
        }
